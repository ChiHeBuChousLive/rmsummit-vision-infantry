...
void Workspace::showImage()  // TODO
{
    ...
    cv::createTrackbar("armor_yaw", window_name_target, &armor_yaw, 200, 0, 0);
    Util::yaw_skew_on_armor = (armor_yaw-100.0)/10.0;

    static int armor_pitch = Util::pitch_skew_on_armor;
    cv::createTrackbar("armor_pitch", window_name_target, &armor_pitch, 200, 0, 0);
    Util::pitch_skew_on_armor = (armor_pitch - 100.0)/10.0;
