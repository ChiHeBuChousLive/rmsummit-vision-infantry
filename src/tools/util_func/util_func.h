...
public:
   ...
   /// y轴补偿值，单位为毫米
   constexpr static double Y_OFFSET = -62.363;

   /// z轴补偿值，单位为毫米
   constexpr static double Z_OFFSET = 148.760;
   ...
   /// 小弹丸空气阻力系数（f = -k*v^2）
   constexpr static double k = 7.1655 * 0.00001; //TODO

   /// 小弹丸质量
   constexpr static double m = 3.2 * 0.001;
public:
    /**
     * @brief 获取二维点的欧氏距离
     * @param point1 点1
